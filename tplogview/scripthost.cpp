...
public:
	...
	{
		*pTime = (double)m_info->item->log_time_sec + m_info->item->log_time_msec / 1000000.0;
		return S_OK;
	}
...
CScriptHost::CScriptHost()
{
	...
	HRESULT hr = CoCreateInstance(CLSID_JScript, NULL, CLSCTX_SERVER, IID_IActiveScript, (void**)&m_scriptEngine);
	if (FAILED(hr))
	{
		// TODO: log
		return;
