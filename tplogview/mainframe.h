...
//		COMMAND_HANDLER(IDC_SEARCH_EDIT, EN_CHANGE, OnSearchEditChange)
		...
		COMMAND_ID_HANDLER(ID_EXIT, OnFileClose)
        ...
        COMMAND_ID_HANDLER(ID_TOGGLE_CONNECT_PIPE, OnToggleConnectPipe)
        COMMAND_ID_HANDLER(ID_TOGGLE_CONNECT_DEBUG_OUTPUT, OnToggleConnectDebugOutput)
        COMMAND_ID_HANDLER(ID_TOGGLE_CONNECT_GLOBAL_DEBUGOUTPUT, OnToggleConnectGlobalDebugoutput)
	...
	BEGIN_UPDATE_UI_MAP(CMainFrame)
        ...
        UPDATE_ELEMENT(ID_TOGGLE_CONNECT_PIPE, UPDUI_MENUPOPUP)
        UPDATE_ELEMENT(ID_TOGGLE_CONNECT_DEBUG_OUTPUT, UPDUI_MENUPOPUP)
        UPDATE_ELEMENT(ID_TOGGLE_CONNECT_GLOBAL_DEBUGOUTPUT, UPDUI_MENUPOPUP)
...
public:
    ...
    LRESULT OnToggleConnectPipe(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/);
    LRESULT OnToggleConnectDebugOutput(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/);
    LRESULT OnToggleConnectGlobalDebugoutput(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/);
};
